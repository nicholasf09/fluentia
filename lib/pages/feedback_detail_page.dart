...
class FeedbackDetailPage extends StatefulWidget {
  final String userId;
  final String feedbackId; // diambil dari history
...
class _FeedbackDetailPageState extends State<FeedbackDetailPage> {
  ...
  void initState() {
    super.initState();
    _fetchFeedbackDetail();
  }

  // ====================================================
  // 📡 Ambil feedback dari database berdasarkan feedbackId
  // ====================================================
  Future<void> _fetchFeedbackDetail() async {
    setState(() {
      _isLoading = true;
      error = null;
    });
    ...
    try {
      final result = await ApiService.getFeedbackById(widget.feedbackId);
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 2),
                      Text(
                        createdAt != null ? "Dibuat pada $createdAt" : "",
                        style: TextStyle(
                          fontSize: 12,
